...
function HandleAppCommandEvent(evt) {
  ...
  case "Find":
    ...
    break;
  case "Help":
    openUILink('https://8pecxstudios.com/Forums/index.php');
    break;
  case "Open":
...
var gIdentityHandler = {
  ...
  */
  ...
  setURI(uri) {
    ...
    let whitelist = /^(?:accounts|addons|buildconfig|cache|config|crashes|customizing|downloads|home|license|logo|memory|networking|newaddon|permissions|plugins|preferences|privatebrowsing|rights|searchreset|sessionrestore|support|serviceworkers|welcomeback)(?:[?#]|$)/i;
