...
if [ -f "$Dir/deb_and_ppa_templates/copyright" ]; then
    cp $Dir/deb_and_ppa_templates/copyright $Dir/deb_and_ppa_stable/cyberfox-unity-edition-$VERSION/debian
else
...
if [ -d "../../../../../obj64/dist/Cyberfox" ]; then
	...
	cp $Dir/deb_and_ppa_templates/vendor-gre.js $Dir/deb_and_ppa_stable/cyberfox-unity-edition-$VERSION
else
...
chmod  755 $Dir/deb_and_ppa_stable/cyberfox-unity-edition-$VERSION/debian/control
chmod  755 $Dir/deb_and_ppa_stable/cyberfox-unity-edition-$VERSION/debian/prerm
chmod  755 $Dir/deb_and_ppa_stable/cyberfox-unity-edition-$VERSION/debian/copyright
...
cd $Dir/deb_and_ppa
dput ppa:8pecxstudios/cyberfox cyberfox-unity-edition-$VERSION-0~ppa1.source.changes
